typedef struct {
    char *ola,*olauser,*primeiraguess,*comofui,*mtalta,*proximaguess,*mtbaixa,*consegui,*tentativas,*unumero,*jogardnv,*suaguess,*guesserrada,*foramachados;
} LANG;
LANG *initLang() {
    ...
    l->guesserrada = malloc(sizeof(char) * 100);
    l->foramachados = malloc(sizeof(char) * 100);
    return l;
}
